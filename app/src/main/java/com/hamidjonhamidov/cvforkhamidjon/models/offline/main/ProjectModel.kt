...
data class ProjectModel(
    ...
    override fun toString(): String {
        return "ProjectModel(projectId=$projectId, projectTime='$projectTime', projectTitle='$projectTitle', projectDes='$projectDes', projectLink='$projectLink', projectGitLink='$projectGitLink')"
    }
}